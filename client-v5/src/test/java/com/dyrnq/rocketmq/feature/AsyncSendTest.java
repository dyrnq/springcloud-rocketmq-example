...
/**
 * Verifies asynchronous message send via the V5 gRPC client and asserts the
 * send callback completes with a {@link SendReceipt}.
 *
 * <p>Replaces the body of {@code org.apache.rocketmq.client.java.example.AsyncProducerExample.main}.</p>
 */
...
class AsyncSendTest {
    ...
    void sendAsyncNormalMessage() throws Exception {
        ...
        assertNull(future.isCompletedExceptionally() ? new RuntimeException("x") : null,
