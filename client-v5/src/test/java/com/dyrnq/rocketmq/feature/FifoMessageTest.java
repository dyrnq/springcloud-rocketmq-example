...
/**
 * Verifies FIFO message ordering by sending 4 messages with the same {@code messageGroup} via the
 * V5 gRPC client and asserting the order in which the push consumer receives them.
 *
 * <p>Replaces the body of {@code
 * org.apache.rocketmq.client.java.example.ProducerFifoMessageExample.main}.
 */
...
class FifoMessageTest {
  ...
  void sendFifoMessagesInOrder() throws Exception {
    ...
    org.junit.jupiter.api.Assertions.assertTrue(
        matched.containsAll(expected), "All sent FIFO messages should be received");
  }
}
