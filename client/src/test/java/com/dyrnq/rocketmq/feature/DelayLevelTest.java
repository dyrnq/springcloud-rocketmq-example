...
/**
 * Verifies fixed-level delayed messages. Send a message with
 * {@code setDelayTimeLevel(2)} (5s) to {@link Topics#TOPIC_DELAY} and assert
 * that it is delivered at least 4s after send time.
 *
 * <p>Replaces the body of {@code com.dyrnq.rocketmq.delay.DelayMessageProducer.main}
 * and {@code com.dyrnq.rocketmq.delay.ScheduledMessageConsumer.main}.</p>
 */
class DelayLevelTest {
    ...
    void sendsAndReceivesLevelDelayedMessage() throws Exception {
        ...
        assertTrue(elapsed >= EXPECTED_DELAY_MS - DELAY_TOLERANCE_MS,
