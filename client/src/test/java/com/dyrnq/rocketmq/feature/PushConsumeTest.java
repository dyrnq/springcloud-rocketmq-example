...
/**
 * Verifies that a push consumer subscribes to {@link Topics#TOPIC_A} and receives the message that
 * was sent to it.
 *
 * <p>Replaces the body of {@code com.dyrnq.rocketmq.simple.SimplePushConsumer.main}.
 */
class PushConsumeTest {
  ...
  void receivesOneMessageAfterProducerSends() throws Exception {
    Message msg =
        new Message(Topics.TOPIC_A, "yourMessageTagA", bodyMarker.getBytes(StandardCharsets.UTF_8));
