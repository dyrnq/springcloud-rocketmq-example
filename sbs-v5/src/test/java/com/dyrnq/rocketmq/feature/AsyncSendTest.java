...
/**
 * Verifies async send via {@code RocketMQClientTemplate.asyncSendNormalMessage}
 * (replaces {@code ProducerRunner.testAsyncSendMessage()}).
 */
...
class AsyncSendTest {
    ...
    void asyncSendNormalMessage() throws Exception {
        ...
        rocketMQClientTemplate.asyncSendNormalMessage(Topics.TOPIC_NORMAL,
            "sbs-v5-async", future);
