...
/**
 * Verifies a V5 push consumer subscribes to {@link Topics#TOPIC_NORMAL} and receives a message
 * (replaces the consumer side of {@code V5PushConsumerRunner}).
 */
