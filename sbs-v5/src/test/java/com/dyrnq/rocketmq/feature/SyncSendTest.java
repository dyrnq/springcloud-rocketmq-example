...
/**
 * Verifies that {@link RocketMQClientTemplate#syncSendNormalMessage(String, Object)} succeeds
 * (replaces the body of {@code ProducerRunner.testSendNormalMessage()}).
 */
...
class SyncSendTest {
  ...
  void syncSendNormalMessage() {
    SendReceipt receipt =
        rocketMQClientTemplate.syncSendNormalMessage(Topics.TOPIC_NORMAL, "sbs-v5-sync");
