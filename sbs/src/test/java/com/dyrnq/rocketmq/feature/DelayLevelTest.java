...
/**
 * Verifies a V4 fixed-delay message (delay level 2 = 5s) sent via a raw
 * {@link DefaultMQProducer} is delivered to a push consumer on
 * {@link Topics#TOPIC_DELAY} at least 4s after send time.
 *
 * <p>Uses the raw V4 client APIs (instead of {@code RocketMQTemplate})
 * because the V4 {@code Message.setDelayTimeLevel} is the canonical V4
 * fixed-delay API.</p>
 *
