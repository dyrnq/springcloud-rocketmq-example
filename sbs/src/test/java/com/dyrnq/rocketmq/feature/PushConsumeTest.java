...
/**
 * Verifies that a push consumer subscribes to {@link Topics#TOPIC_DEMO_TOPIC}
 * and receives a message — exercised here with a raw V4 consumer (the
 * V4 push consumer is provided by spring-boot-starter; the test uses an
 * independent consumer to keep test wiring self-contained).
 */
...
class PushConsumeTest {
    ...
    void receivesOneMessageAfterProducerSends() throws Exception {
        Message msg = new Message(Topics.TOPIC_DEMO_TOPIC, "yourMessageTagA",
