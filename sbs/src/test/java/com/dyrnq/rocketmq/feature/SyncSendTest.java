...
/**
 * Verifies that {@link RocketMQTemplate#syncSend(String, Object)} succeeds via the
 * rocketmq-spring-boot-starter (V4 client).
 *
 * <p>Replaces the body of {@code com.dyrnq.rocketmq.sbs.ProducerRunner.run}.
 */
