...
--restart always \
-e TZ="Asia/Shanghai" \
-e JAVA_OPT_EXT="-Duser.home=/home/rocketmq -XX:+IgnoreUnrecognizedVMOptions -XX:-UseG1GC -XX:+UseZGC -XX:+PrintFlagsFinal -Xms2g -Xmx2g -Xmn128m -XX:MetaspaceSize=128m -XX:MaxMetaspaceSize=128m" \
