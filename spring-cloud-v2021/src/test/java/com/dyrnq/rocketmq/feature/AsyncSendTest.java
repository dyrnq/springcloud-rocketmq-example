 ...
 * {@link StreamBridge}. Body is inlined (rather than calling
 * {@code com.dyrnq.rocketmq.testsupport.StreamBridgeSendHelper}) because
 * the four spring-cloud-v* modules use different spring-cloud-stream
 * majors and the helper was compiled against 4.0.0.
 *
 * <p>Replaces the body of {@code com.dyrnq.sca.rocketmq.StreamProducerRunner.run}
 * for spring-cloud-v2021.</p>
 */
