 ...
 * for spring-cloud-v2023 (the original sent 100 messages in a tight loop
 * with delay level 19; this test sends a single message and asserts the
 * binder dispatched it without error).</p>
 */
