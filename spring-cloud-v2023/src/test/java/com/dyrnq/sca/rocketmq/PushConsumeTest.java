...
/**
 * Verifies the Spring Cloud Stream binder end-to-end for spring-cloud-v2023.
 * Sends a message via {@link StreamBridge} and asserts a raw V4 push
 * consumer on the same topic ({@code demo}) receives it. The function-bean
 * wiring ({@code StreamConsumer.consumerEvent}) is exercised by the
 * {@code @SpringBootTest} context boot; this test verifies the broker
 * round-trip.
 */
