...
/**
 * Verifies the Spring Cloud Stream binder end-to-end for spring-cloud-v2025-1.
 * Sends a message via {@link StreamBridge} and asserts a raw V4 push
 * consumer on the same topic ({@code demo}) receives it.
 */
...
class PushConsumeTest {
    ...
    void receivesOneMessageAfterStreamBridgeSend() throws Exception {
        String body = "v2025-1-push-marker-" + UUID.randomUUID();
