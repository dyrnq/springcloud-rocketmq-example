 ...
 *
 * <p>These constants are the single source of truth for the broker endpoint. To switch the entire
 * test suite to a different VM, change these values (and re-run {@code
 * scripts/run-containers-controller.sh} on the new host).
 */
