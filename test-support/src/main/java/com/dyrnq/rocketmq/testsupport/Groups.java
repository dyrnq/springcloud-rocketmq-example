 ...
 *
 * <p>{@link #uniquePush()} and {@link #uniqueSimple()} return fresh per-test names so
 * repeated runs don't see stale offsets. Stable names are also exported for tests that
 * want to assert on a known group (e.g. demo flow assertions).</p>
 */
