 ...
 *
 * <p>The on-broker topics pre-created by {@code scripts/run-containers-controller.sh} are {@code
 * delayTopic}, {@code fifoTopic}, {@code normalTopic}, {@code transTopic}, {@code demo-topic},
 * {@code topic_a}, {@code topic_b}. The remaining constants are used by tests for producer-only or
 * auto-create flows.
 */
